...
const ProductPage = () => {
    ...
    const [productSize, setProductSize] = useState({ S: false, M: false, L: false, XL: false })
                ...
                <div style={{ textAlign: "start" }}>
                    ...
                    <ul>
                        ...
                        {productData.treatmentInstructions ?
                            <li>Инструкция за третиране: {productData.treatmentInstructions}</li> :
                            null
                        }
                    </ul>
                    ...
                    <ul>
                        {productData.length ?
                            <li>Дължина: {productData.length}</li> :
                            null
                        }

                        {productData.color ?
                            <li>Цвят: {productData.color}</li> :
                            null
                        }
                    ...
                    <Row>
                        ...
                        <Col>
                            ...
                            {productData.size ?
                                ...
                                productData.size.map((singleSize) => {
                                    return <Button variant='secondary' onClick={() => chooseSize(singleSize)} active={productSize[singleSize]}>{singleSize}</Button>
                                })
                                :
                                null
                            }
                        ...
                        <Col>
                            <Button variant='secondary' size='lg'>КУПИ</Button>
                        </Col>
